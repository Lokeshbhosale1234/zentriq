    ...
    <>
      ...
      <aside
        ...
        style={{
          ...
          transition: 'width 220ms ease-in-out, transform 220ms ease-in-out',
          overflow: 'hidden',
        }}
      ...
      >
        {/* ── Logo row ────────────────────────────────────────────── */}
        <div style={{
          height: 'var(--topbar-h)', padding: '0 14px 0 20px',
        ...
        <nav style={{ padding: '10px 8px', flex: 1, overflowY: 'auto', overflowX: 'hidden' }}>
          <p className={`sidebar-section-label sidebar-fade ${collapsed ? 'is-collapsed' : ''}`} style={{ padding: '4px 8px 8px' }}>Menu</p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            {NAV.map(item => (
              ...
              >
                ...
                <span className={`sidebar-fade ${collapsed ? 'is-collapsed' : ''}`} style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
          ...
          <p className={`sidebar-section-label sidebar-fade ${collapsed ? 'is-collapsed' : ''}`} style={{ padding: '4px 8px 8px' }}>Coming Soon</p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            {SOON.map(item => (
              <div
                key={item.to}
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              padding: collapsed ? '9px 0' : '9px 10px', borderRadius: 9,
              background: showAccountMenu ? 'rgba(255,255,255,0.07)' : 'rgba(255,255,255,0.04)',
              border: '1px solid rgba(255,255,255,0.06)',
              overflow: 'hidden', cursor: 'pointer', textAlign: 'left',
              transition: 'background 0.14s ease, padding 220ms ease-in-out',
            }}
            aria-haspopup="menu"
          ...
          >
            ...
            <span className={`sidebar-fade ${collapsed ? 'is-collapsed' : ''}`} style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 8, minWidth: 0 }}>
