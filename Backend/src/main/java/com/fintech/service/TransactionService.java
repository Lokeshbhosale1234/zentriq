...
import com.fintech.specification.TransactionSpecification;
...
public class TransactionService {
        ...
        public AnalyticsDTO getAnalytics() {
                ...
                List<Object[]> categoryData = transactionRepository.findCategoryBreakdownByUser(user,
                                TransactionType.DEBIT);
                ...
                List<Object[]> trendData = transactionRepository.findMonthlyTrendByUser(
                                user,
                                sixMonthsAgo);
                ...
                for (int i = 5; i >= 0; i--) {
                        ...
                        String monthKey = LocalDateTime.now()
                                        .minusMonths(i)
                                        .format(formatter);
